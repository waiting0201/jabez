...
function TravelPaymentForm_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 58);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 53);
    \u0275\u0275element(3, "use", 59);
    \u0275\u0275elementEnd();
...
function TravelPaymentForm_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 60);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 53);
    \u0275\u0275element(3, "use", 61);
    \u0275\u0275elementEnd();
...
function TravelPaymentForm_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "\u7C3D\u6838\u72C0\u614B");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "span", 62);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function TravelPaymentForm_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "div", 16)(6, "label", 64);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(7, "svg", 65);
    \u0275\u0275element(8, "use", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
function TravelPaymentForm_For_96_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "select", 75)(1, "option", 90);
    \u0275\u0275text(2, "\u9078\u64C7");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, TravelPaymentForm_For_96_Conditional_7_For_4_Template, 2, 2, "option", 91, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TravelPaymentForm_For_96_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 88)(1, "button", 94);
...
function TravelPaymentForm_For_96_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275declareLet(0);
    \u0275\u0275elementStart(1, "tr", 47)(2, "td", 70);
    \u0275\u0275conditionalCreate(3, TravelPaymentForm_For_96_Conditional_3_Template, 3, 2, "button", 71)(4, TravelPaymentForm_For_96_Conditional_4_Template, 1, 0, "span", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 73);
    \u0275\u0275conditionalCreate(6, TravelPaymentForm_For_96_Conditional_6_Template, 2, 1, "span", 74)(7, TravelPaymentForm_For_96_Conditional_7_Template, 5, 0, "select", 75);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "td", 73);
    \u0275\u0275conditionalCreate(9, TravelPaymentForm_For_96_Conditional_9_Template, 2, 1, "span", 74)(10, TravelPaymentForm_For_96_Conditional_10_Template, 1, 0, "input", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 73);
    \u0275\u0275conditionalCreate(12, TravelPaymentForm_For_96_Conditional_12_Template, 2, 1, "span", 74)(13, TravelPaymentForm_For_96_Conditional_13_Template, 1, 0, "input", 77);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 73);
    \u0275\u0275conditionalCreate(15, TravelPaymentForm_For_96_Conditional_15_Template, 3, 4, "span", 74)(16, TravelPaymentForm_For_96_Conditional_16_Template, 2, 0, "div", 78)(17, TravelPaymentForm_For_96_Conditional_17_Template, 1, 0, "input", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td", 73);
    \u0275\u0275conditionalCreate(19, TravelPaymentForm_For_96_Conditional_19_Template, 2, 1, "span", 74)(20, TravelPaymentForm_For_96_Conditional_20_Template, 2, 0, "div", 78)(21, TravelPaymentForm_For_96_Conditional_21_Template, 1, 0, "input", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "td", 73);
    \u0275\u0275conditionalCreate(23, TravelPaymentForm_For_96_Conditional_23_Template, 3, 4, "span", 81)(24, TravelPaymentForm_For_96_Conditional_24_Template, 2, 0, "div", 78)(25, TravelPaymentForm_For_96_Conditional_25_Template, 1, 0, "input", 82);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "td", 73);
    \u0275\u0275conditionalCreate(27, TravelPaymentForm_For_96_Conditional_27_Template, 2, 1, "span", 74)(28, TravelPaymentForm_For_96_Conditional_28_Template, 1, 0, "input", 83);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "td", 73);
    \u0275\u0275conditionalCreate(30, TravelPaymentForm_For_96_Conditional_30_Template, 2, 1, "span", 84)(31, TravelPaymentForm_For_96_Conditional_31_Template, 3, 0, "div", 85)(32, TravelPaymentForm_For_96_Conditional_32_Template, 1, 0, "input", 86);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "td", 73);
    \u0275\u0275conditionalCreate(34, TravelPaymentForm_For_96_Conditional_34_Template, 2, 1, "span", 74)(35, TravelPaymentForm_For_96_Conditional_35_Template, 3, 0, "div", 85)(36, TravelPaymentForm_For_96_Conditional_36_Template, 1, 0, "input", 87);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(37, TravelPaymentForm_For_96_Conditional_37_Template, 4, 1, "td", 88);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
...
function TravelPaymentForm_Conditional_98_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tfoot")(1, "tr", 38)(2, "td", 97);
    \u0275\u0275text(3, "\u5408\u8A08");
    \u0275\u0275elementEnd();
...
function TravelPaymentForm_Conditional_99_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8, "\u6307\u5B9A\u5BE9\u6838\u8005\uFF08\u4F9D\u5E8F\u5BE9\u6838\uFF09");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(9, TravelPaymentForm_Conditional_99_For_10_Template, 16, 9, "div", 101, \u0275\u0275repeaterTrackByIndex);
...
function TravelPaymentForm_Conditional_100_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8, "\u6307\u5B9A\u5BE9\u6838\u8005\uFF08\u4F9D\u5E8F\u5BE9\u6838\uFF09");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "ol", 107);
    \u0275\u0275repeaterCreate(10, TravelPaymentForm_Conditional_100_For_11_Template, 2, 1, "li", 74, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function TravelPaymentForm_Conditional_101_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-installments-table", 48);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("installmentsInput", ctx_r1.installments)("paymentStatus", ctx_r1.paymentStatus ?? void 0)("totalAmount", ctx_r1.loadedGrandTotal);
  }
}
function TravelPaymentForm_Conditional_103_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 50)(1, "button", 108);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function TravelPaymentForm_Conditional_104_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "a", 110);
    \u0275\u0275text(2, "\u8FD4\u56DE\u5217\u8868");
    \u0275\u0275elementEnd()();
  }
}
function TravelPaymentForm_Conditional_105_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-file-preview-modal", 111);
...
function TravelPaymentForm_ng_template_106_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "h5", 116);
    \u0275\u0275text(6, "\u7533\u8ACB\u6210\u529F");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 117);
    \u0275\u0275text(8, "\u8ACB\u76E1\u65E9\u5C07\u6B63\u672C\u8CC7\u6599\u9001\u56DE\u7BA1\u7406\u8655");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 118)(10, "button", 119);
...
var TravelPaymentForm = class _TravelPaymentForm {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TravelPaymentForm, selectors: [["app-travel-payment-form"]], viewQuery: function TravelPaymentForm_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(101, TravelPaymentForm_Conditional_101_Template, 1, 3, "app-installments-table", 48);
      \u0275\u0275element(102, "app-approval-timeline", 49);
      \u0275\u0275conditionalCreate(103, TravelPaymentForm_Conditional_103_Template, 7, 3, "div", 50)(104, TravelPaymentForm_Conditional_104_Template, 3, 0, "div", 51);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275conditionalCreate(105, TravelPaymentForm_Conditional_105_Template, 1, 1, "app-file-preview-modal", 52);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.installments && ctx.installments.length > 0 ? 101 : -1);
      \u0275\u0275advance();
  ...
  }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, MinValidator, FormGroupDirective, FormControlName, FormGroupName, FormArrayName, FormsModule, NgModel, RouterLink, ApprovalTimeline, FilePreviewModal, InstallmentsTable, DecimalPipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TravelPaymentForm, [{
    type: Component,
    args: [{ selector: "app-travel-payment-form", imports: [ReactiveFormsModule, FormsModule, RouterLink, DecimalPipe, ApprovalTimeline, FilePreviewModal, InstallmentsTable], template: `<div class="container-fluid py-3">
      ...
      <div class="col-12 col-xl-10">
        ...
        @if (installments && installments.length > 0) {
          <app-installments-table
            [installmentsInput]="installments"
            [paymentStatus]="paymentStatus ?? undefined"
            [totalAmount]="loadedGrandTotal" />
        }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TravelPaymentForm, { className: "TravelPaymentForm", filePath: "src/app/features/admin/travel-payment-requests/pages/travel-payment-form/travel-payment-form.ts", lineNumber: 31 });
})();
export {
  TravelPaymentForm
};
//# sourceMappingURL=chunk-HE3HMFQV.js.map
