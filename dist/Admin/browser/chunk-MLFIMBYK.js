...
var AuthService = class _AuthService {
  ...
  isSuperAdmin = computed(() => {
    const payload = this._decode(this._token());
    return !!payload && payload.exp * 1e3 > Date.now() && !!payload.is_superadmin;
  ...
  _mockJwt(email) {
    ...
    const payload = btoa(JSON.stringify({
      ...
      is_superadmin: isSuperAdmin || void 0,
      permissions: isSuperAdmin ? [] : [
        ...
        "travel-requests:read",
        "travel-requests:write",
        "travel-requests:delete"
      ],
...
var permissionGuard = (route) => {
  ...
  if (!permission)
    return true;
  return auth.hasPermission(permission) ? true : router.createUrlTree(["/error/403"]);
};
...
var MOCK_TASKS = [
  ...
  },
  {
    ...
    approvalRecords: [
      { stepOrder: 1, action: "approved", reviewedBy: "Alice", reviewedAt: /* @__PURE__ */ new Date("2024-04-11") },
      { stepOrder: 2, action: "approved", reviewedBy: "Alice", reviewedAt: /* @__PURE__ */ new Date("2024-04-12"), reviewNote: "\u91D1\u984D\u6838\u5BE6\u7121\u8AA4\uFF0C\u5DF2\u6838\u51C6\u3002" }
    ],
    paymentDetail: {
      paymentRequestId: 1,
      paymentType: "vendor",
  ...
  },
  {
    ...
    reviewNote: "\u6838\u51C6",
    approvalRecords: [
      { stepOrder: 1, action: "approved", reviewedBy: "Alice", reviewedAt: /* @__PURE__ */ new Date("2026-02-20"), reviewNote: "\u6838\u51C6" },
      { stepOrder: 2, action: "approved", reviewedBy: "Alice", reviewedAt: /* @__PURE__ */ new Date("2026-02-20"), reviewNote: "\u6838\u51C6" }
    ],
    leaveDetail: {
      leaveRequestId: 2,
      leaveType: "sick",
...
var ApprovalTaskService = class _ApprovalTaskService {
  ...
  review(id, applicationType, action, reviewNote) {
    ...
    const updated = this.items$.getValue().map((t) => t.id === id && t.applicationType === applicationType ? __spreadProps(__spreadValues({}, t), {
      status: newStatus,
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MLFIMBYK.js.map
