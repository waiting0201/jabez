...
var TravelPaymentRequestService = class _TravelPaymentRequestService {
  ...
  create(data) {
    return this.http.post(`${environment.apiUrl}/travel-payment-requests`, data);
  }
  update(id, changes) {
    return this.http.patch(`${environment.apiUrl}/travel-payment-requests/${id}`, changes);
  }
  delete(id) {
...
//# sourceMappingURL=chunk-XO7HHABQ.js.map
