...
} from "./chunk-ODOUDVYE.js";
import {
  FilePreviewModal
} from "./chunk-5VZHJL4Z.js";
import "./chunk-NXTOFNYH.js";
import {
  ApprovalTimeline
} from "./chunk-LL6IEINF.js";
import {
  ApprovalTaskService
...
function TravelPaymentDetail_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, TravelPaymentDetail_Conditional_1_Conditional_10_Conditional_1_Template, 1, 0, "span", 33)(2, TravelPaymentDetail_Conditional_1_Conditional_10_Conditional_2_Template, 2, 0, ":svg:svg", 13);
    \u0275\u0275text(3, " \u5217\u5370 PDF ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TravelPaymentDetail_Conditional_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, TravelPaymentDetail_Conditional_1_Conditional_12_Conditional_5_Template, 1, 0, "span", 33)(6, TravelPaymentDetail_Conditional_1_Conditional_12_Conditional_6_Template, 2, 0, ":svg:svg", 13);
    \u0275\u0275text(7, " \u522A\u9664 ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TravelPaymentDetail_Conditional_1_Conditional_68_For_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, TravelPaymentDetail_Conditional_1_Conditional_68_For_31_Conditional_2_Template, 3, 2, "button", 51);
    \u0275\u0275elementEnd();
...
function TravelPaymentDetail_Conditional_1_Conditional_68_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "div", 41)(6, "div", 42)(7, "table", 43)(8, "thead", 44)(9, "tr");
    \u0275\u0275element(10, "th", 45);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "tfoot")(33, "tr", 44)(34, "td", 47);
    \u0275\u0275text(35, "\u5408\u8A08");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "td", 48);
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275element(39, "td", 49);
...
function TravelPaymentDetail_Conditional_1_Conditional_69_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "div", 21)(6, "div", 61);
...
function TravelPaymentDetail_Conditional_1_Conditional_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-approval-timeline", 31);
  }
  if (rf & 2) {
    const task_r7 = ctx;
...
function TravelPaymentDetail_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(70, TravelPaymentDetail_Conditional_1_Conditional_70_Template, 1, 4, "app-approval-timeline", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_18_0;
...
function TravelPaymentDetail_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-file-preview-modal", 66);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TravelPaymentDetail, [{
    type: Component,
    args: [{ selector: "app-travel-payment-detail", imports: [RouterLink, DecimalPipe, DatePipe, ApprovalTimeline, FilePreviewModal], template: `<div class="container-fluid py-3">
  @if (request(); as r) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TravelPaymentDetail, { className: "TravelPaymentDetail", filePath: "src/app/features/admin/travel-payment-requests/pages/travel-payment-detail/travel-payment-detail.ts", lineNumber: 18 });
})();
export {
  TravelPaymentDetail
};
//# sourceMappingURL=chunk-Z7RE563A.js.map
