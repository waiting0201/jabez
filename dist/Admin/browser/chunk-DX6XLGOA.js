...
} from "./chunk-WLO7RWZG.js";
import {
  toObservable,
  toSignal
} from "./chunk-E5ZXS5IF.js";
import {
  RouterLink
} from "./chunk-EZTP5B4O.js";
import "./chunk-2PTEUK7R.js";
import {
  Component,
  DatePipe,
  DecimalPipe,
...
function HolidayTravelRequestList_For_37_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelRequestList_For_37_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelRequestList_For_37_Conditional_24_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275listener("click", function HolidayTravelRequestList_For_37_Conditional_24_Conditional_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function HolidayTravelRequestList_For_37_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "use", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(3, HolidayTravelRequestList_For_37_Conditional_24_Conditional_3_Template, 3, 0, "button", 30);
  }
  if (rf & 2) {
    const r_r1 = \u0275\u0275nextContext().$implicit;
...
function HolidayTravelRequestList_For_37_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelRequestList_For_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(10, HolidayTravelRequestList_For_37_Conditional_10_Template, 2, 1, "span", 18)(11, HolidayTravelRequestList_For_37_Conditional_11_Template, 2, 0, "span", 21);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "td", 25)(23, "div", 26);
    \u0275\u0275conditionalCreate(24, HolidayTravelRequestList_For_37_Conditional_24_Template, 4, 4)(25, HolidayTravelRequestList_For_37_Conditional_25_Template, 3, 3, "a", 27);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 17, r_r1.grandTotal, "1.0-0"));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(r_r1.approvalStatus === "draft" || r_r1.approvalStatus === "returned" ? 24 : 25);
  }
}
function HolidayTravelRequestList_ForEmpty_38_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelRequestList_Conditional_39_For_15_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelRequestList_Conditional_39_For_15_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 40)(1, "button", 41);
    \u0275\u0275listener("click", function HolidayTravelRequestList_Conditional_39_For_15_Conditional_1_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
...
function HolidayTravelRequestList_Conditional_39_For_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, HolidayTravelRequestList_Conditional_39_For_15_Conditional_0_Template, 3, 0, "li", 42)(1, HolidayTravelRequestList_Conditional_39_For_15_Conditional_1_Template, 3, 3, "li", 43);
  }
  if (rf & 2) {
...
function HolidayTravelRequestList_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "span", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 36)(4, "button", 37);
    \u0275\u0275listener("click", function HolidayTravelRequestList_Conditional_39_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function HolidayTravelRequestList_Conditional_39_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function HolidayTravelRequestList_Conditional_39_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.prev());
    });
    \u0275\u0275text(13, "\u2039");
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(14, HolidayTravelRequestList_Conditional_39_For_15_Template, 2, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(16, "li", 40)(17, "button", 41);
    \u0275\u0275listener("click", function HolidayTravelRequestList_Conditional_39_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.next());
    });
...
var HolidayTravelRequestList = class _HolidayTravelRequestList {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HolidayTravelRequestList, selectors: [["app-holiday-travel-request-list"]], decls: 40, vars: 2, consts: [[1, "container-fluid", "py-3"], [1, "flex", "flex-wrap", "items-center", "justify-between", "gap-2", "mb-6"], [1, "flex", "items-center", "gap-2"], [1, "sa-icon", "sa-icon-2x", "text-primary", 2, "stroke", "currentColor"], ["href", "/assets/icons/sprite.svg#sun"], [1, "mb-0"], ["routerLink", "new", 1, "btn", "btn-primary", "inline-flex", "items-center", "gap-1"], [1, "sa-icon", 2, "stroke", "currentColor"], ["href", "/assets/icons/sprite.svg#plus"], [1, "card", "border-0", "shadow-sm"], [1, "card-body", "p-0"], [1, "table-responsive"], [1, "table", "table-hover", "mb-0"], [1, "table-light"], [1, "text-right"], [1, "hidden", "md:table-cell"], [1, "hidden", "lg:table-cell"], [1, "flex", "flex-col", "gap-2", "sm:flex-row", "sm:items-center", "sm:justify-between", "px-4", "py-3", "border-t"], [1, "fw-500"], [1, "text-muted", "small"], [1, "text-right", "small"], [1, "text-muted"], [1, "text-right", "fw-500"], [1, "text-muted", "small", "hidden", "md:table-cell"], [1, "font-monospace", "small", "hidden", "lg:table-cell"], [1, "text-right", 2, "white-space", "nowrap"], [1, "flex", "justify-end", "gap-1"], ["title", "\u6AA2\u8996", 1, "btn", "btn-sm", "btn-ghost-secondary", "inline-flex", "items-center", 3, "routerLink"], ["title", "\u7DE8\u8F2F", 1, "btn", "btn-sm", "btn-ghost-primary", "inline-flex", "items-center", 3, "routerLink"], ["href", "/assets/icons/sprite.svg#edit"], ["title", "\u522A\u9664", 1, "btn", "btn-sm", "btn-ghost-danger", "inline-flex", "items-center"], ["title", "\u522A\u9664", 1, "btn", "btn-sm", "btn-ghost-danger", "inline-flex", "items-center", 3, "click"], ["href", "/assets/icons/sprite.svg#trash"], ["href", "/assets/icons/sprite.svg#eye"], ["colspan", "9", 1, "text-center", "text-muted", "py-4"], [1, "text-muted", "small", "text-center", "sm:text-left"], [1, "flex", "sm:hidden", "items-center", "gap-1"], [1, "page-link", "rounded", 3, "click"], [1, "px-2", "text-sm"], [1, "hidden", "sm:flex", "pagination", "mb-0"], [1, "page-item"], [1, "page-link", 3, "click"], [1, "page-item", "disabled"], [1, "page-item", 3, "active"], [1, "page-link"]], template: function HolidayTravelRequestList_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(36, HolidayTravelRequestList_For_37_Template, 26, 20, "tr", null, _forTrack0, false, HolidayTravelRequestList_ForEmpty_38_Template, 3, 0, "tr");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(39, HolidayTravelRequestList_Conditional_39_Template, 19, 13, "div", 17);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(36);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HolidayTravelRequestList, [{
    type: Component,
    args: [{ selector: "app-holiday-travel-request-list", imports: [RouterLink, DatePipe, DecimalPipe], template: `<div class="container-fluid py-3">
...
//# sourceMappingURL=chunk-DX6XLGOA.js.map
