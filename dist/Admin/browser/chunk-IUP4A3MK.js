...
var ApprovalTaskService = class _ApprovalTaskService {
  ...
  review(id, applicationType, action, reviewNote, estimatedRefundDate, refundedAt, closeAdvance, installments) {
    return this.http.patch(`${environment.apiUrl}/approval-tasks/${applicationType}/${id}/review`, { action, reviewNote, applicationType, estimatedRefundDate, refundedAt, closeAdvance, installments }).pipe(switchMap((updated) => this.notification.refresh().pipe(map(() => updated))));
  }
...
//# sourceMappingURL=chunk-IUP4A3MK.js.map
