...
function HolidayTravelDetail_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, HolidayTravelDetail_Conditional_1_Conditional_10_Conditional_1_Template, 1, 0, "span", 30)(2, HolidayTravelDetail_Conditional_1_Conditional_10_Conditional_2_Template, 2, 0, ":svg:svg", 31);
    \u0275\u0275text(3, " \u5217\u5370\u7533\u8ACB\u55AE ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HolidayTravelDetail_Conditional_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_5_Template, 1, 0, "span", 30)(6, HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_6_Template, 2, 0, ":svg:svg", 31);
    \u0275\u0275text(7, " \u522A\u9664 ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HolidayTravelDetail_Conditional_1_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "div", 17)(6, "ol", 40);
    \u0275\u0275repeaterCreate(7, HolidayTravelDetail_Conditional_1_Conditional_59_For_8_Template, 2, 1, "li", 41, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const r_r3 = \u0275\u0275nextContext();
...
function HolidayTravelDetail_Conditional_1_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-installments-table", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const r_r3 = \u0275\u0275nextContext();
...
function HolidayTravelDetail_Conditional_1_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-approval-timeline", 28);
  }
  if (rf & 2) {
    const task_r6 = ctx;
...
function HolidayTravelDetail_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(60, HolidayTravelDetail_Conditional_1_Conditional_60_Template, 2, 3, "div", 27);
    \u0275\u0275conditionalCreate(61, HolidayTravelDetail_Conditional_1_Conditional_61_Template, 1, 4, "app-approval-timeline", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_17_0;
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(38, 17, r_r3.createdAt, "yyyy-MM-dd"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(45, 20, r_r3.startDate, "yyyy-MM-dd"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(51, 23, r_r3.endDate, "yyyy-MM-dd"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(r_r3.installments && r_r3.installments.length > 0 ? 60 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_17_0 = ctx_r1.approvalTask()) ? 61 : -1, tmp_17_0);
  }
}
...
var HolidayTravelDetail = class _HolidayTravelDetail {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HolidayTravelDetail, selectors: [["app-holiday-travel-detail"]], decls: 3, vars: 1, consts: [[1, "container-fluid", "py-3"], [1, "text-center", "py-6", "text-muted"], [1, "flex", "flex-wrap", "items-center", "justify-between", "gap-2", "mb-6"], [1, "flex", "items-center", "gap-2", "flex-wrap"], ["routerLink", "/admin/holiday-travel-requests", 1, "btn", "btn-sm", "btn-outline-secondary"], [1, "sa-icon"], ["href", "/assets/icons/sprite.svg#arrow-left"], [1, "mb-0"], [1, "flex", "flex-wrap", "gap-2"], [1, "btn", "btn-outline-secondary", "inline-flex", "items-center", "gap-1", 3, "disabled"], [1, "btn", "btn-outline-primary", "inline-flex", "items-center", "gap-1", 3, "routerLink"], [1, "row", "g-4"], [1, "col-12", "col-xl-10"], [1, "card", "border-0", "shadow-sm", "mb-6"], [1, "card-header", "bg-transparent", "border-bottom", "flex", "items-center", "gap-2", "fw-600"], [1, "sa-icon", "text-primary", 2, "stroke", "currentColor"], ["href", "/assets/icons/sprite.svg#sun"], [1, "card-body"], [1, "row", "g-3", "mb-4"], [1, "col-12", "col-md-6"], [1, "text-muted", "small"], [1, "fw-600"], [1, "col-6", "col-md-3"], [1, "fw-600", 2, "color", "var(--forest)"], [1, "fw-500"], [1, "row", "g-3", "mb-0"], [1, "col-12"], [1, "mb-6"], [3, "flow", "approvalRecords", "currentStepOrder", "status"], [1, "btn", "btn-outline-secondary", "inline-flex", "items-center", "gap-1", 3, "click", "disabled"], ["role", "status", 1, "spinner-border", "spinner-border-sm"], [1, "sa-icon", 2, "stroke", "currentColor"], ["href", "/assets/icons/sprite.svg#printer"], ["href", "/assets/icons/sprite.svg#edit"], [1, "btn", "btn-primary", "inline-flex", "items-center", "gap-1", 3, "click"], ["href", "/assets/icons/sprite.svg#send"], [1, "btn", "btn-outline-danger", "inline-flex", "items-center", "gap-1", 3, "click", "disabled"], ["href", "/assets/icons/sprite.svg#trash-2"], [1, "fw-500", "font-monospace"], ["href", "/assets/icons/sprite.svg#users"], [1, "mb-0", "ps-4"], [1, "small", "fw-500"], [3, "installmentsInput", "paymentStatus", "totalAmount"]], template: function HolidayTravelDetail_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(1, HolidayTravelDetail_Conditional_1_Template, 62, 26)(2, HolidayTravelDetail_Conditional_2_Template, 2, 0, "div", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_0_0;
...
//# sourceMappingURL=chunk-IR27OXMY.js.map
