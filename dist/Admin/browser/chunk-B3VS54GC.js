...
function TravelPaymentForm_Conditional_102_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-installments-table", 115);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function TravelPaymentForm_Conditional_104_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 50)(1, "button", 116);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 117);
    \u0275\u0275listener("click", function TravelPaymentForm_Conditional_104_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r22);
      const ctx_r1 = \u0275\u0275nextContext();
...
function TravelPaymentForm_Conditional_105_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48)(1, "a", 118);
    \u0275\u0275text(2, "\u8FD4\u56DE\u5217\u8868");
    \u0275\u0275elementEnd()();
  }
}
function TravelPaymentForm_Conditional_106_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-file-preview-modal", 119);
    \u0275\u0275listener("closed", function TravelPaymentForm_Conditional_106_Template_app_file_preview_modal_closed_0_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext();
...
function TravelPaymentForm_ng_template_107_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 120)(1, "button", 121);
    \u0275\u0275listener("click", function TravelPaymentForm_ng_template_107_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function TravelPaymentForm_ng_template_107_Template_button_click_10_listener() {
      const modal_r25 = \u0275\u0275restoreView(_r24).$implicit;
      return \u0275\u0275resetView(modal_r25.close());
    });
    \u0275\u0275text(11, "\u78BA\u5B9A");
...
var TravelPaymentForm = class _TravelPaymentForm {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TravelPaymentForm, selectors: [["app-travel-payment-form"]], viewQuery: function TravelPaymentForm_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(102, TravelPaymentForm_Conditional_102_Template, 2, 3, "div", 48);
      \u0275\u0275element(103, "app-approval-timeline", 49);
      \u0275\u0275conditionalCreate(104, TravelPaymentForm_Conditional_104_Template, 7, 3, "div", 50)(105, TravelPaymentForm_Conditional_105_Template, 3, 0, "div", 48);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275conditionalCreate(106, TravelPaymentForm_Conditional_106_Template, 1, 1, "app-file-preview-modal", 51);
      \u0275\u0275template(107, TravelPaymentForm_ng_template_107_Template, 12, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      let tmp_5_0;
      let tmp_10_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.installments && ctx.installments.length > 0 ? 102 : -1);
      \u0275\u0275advance();
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.isReadOnly ? 104 : 105);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.previewFile ? 106 : -1);
    }
  }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, MinValidator, FormGroupDirective, FormControlName, FormGroupName, FormArrayName, FormsModule, NgModel, RouterLink, ApprovalTimeline, FilePreviewModal, InstallmentsTable, DecimalPipe, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TravelPaymentForm, [{
    type: Component,
    args: [{ selector: "app-travel-payment-form", imports: [ReactiveFormsModule, FormsModule, RouterLink, DecimalPipe, DatePipe, ApprovalTimeline, FilePreviewModal, InstallmentsTable], template: `<div class="container-fluid py-3">
