...
var Dashboard = class _Dashboard {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Dashboard, selectors: [["app-dashboard"]], decls: 24, vars: 0, consts: [[1, "container-fluid", "py-3"], [1, "row"], [1, "col-12"], [1, "d-flex", "align-items-center", "gap-3", "mb-4"], [1, "sa-icon", "sa-icon-3x", "text-primary"], ["href", "/assets/icons/sprite.svg#home"], [1, "mb-0"], [1, "text-muted", "mb-0"], [1, "row", "g-3"], [1, "card", "border-0", "shadow-sm"], [1, "card-body", "py-5", "text-center"], [1, "sa-icon", "sa-icon-3x", "text-secondary", "mb-3"], ["href", "/assets/icons/sprite.svg#trello"], [1, "text-muted"], [1, "text-muted", "small"]], template: function Dashboard_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-B7JH54VN.js.map
