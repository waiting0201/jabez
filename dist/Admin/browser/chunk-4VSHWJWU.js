...
function HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 31);
  }
}
function HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function HolidayTravelDetail_Conditional_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_1_Template, 1, 0, "span", 31)(2, HolidayTravelDetail_Conditional_1_Conditional_12_Conditional_2_Template, 2, 0, ":svg:svg", 32);
    \u0275\u0275text(3, " \u5217\u5370\u7533\u8ACB\u55AE ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HolidayTravelDetail_Conditional_1_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Conditional_14_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 31);
  }
}
function HolidayTravelDetail_Conditional_1_Conditional_14_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 32);
    \u0275\u0275element(1, "use", 38);
...
function HolidayTravelDetail_Conditional_1_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 35);
    \u0275\u0275listener("click", function HolidayTravelDetail_Conditional_1_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function HolidayTravelDetail_Conditional_1_Conditional_14_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteRequest());
    });
    \u0275\u0275conditionalCreate(5, HolidayTravelDetail_Conditional_1_Conditional_14_Conditional_5_Template, 1, 0, "span", 31)(6, HolidayTravelDetail_Conditional_1_Conditional_14_Conditional_6_Template, 2, 0, ":svg:svg", 32);
    \u0275\u0275text(7, " \u522A\u9664 ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HolidayTravelDetail_Conditional_1_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Conditional_61_For_8_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, HolidayTravelDetail_Conditional_1_Conditional_61_For_8_Template, 2, 1, "li", 42, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const r_r3 = \u0275\u0275nextContext();
...
function HolidayTravelDetail_Conditional_1_Conditional_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275element(1, "app-installments-table", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const r_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("installmentsInput", r_r3.installments)("paymentStatus", r_r3.paymentStatus)("totalAmount", r_r3.grandTotal ?? 0);
  }
}
function HolidayTravelDetail_Conditional_1_Conditional_63_Template(rf, ctx) {
  if (rf & 1) {
...
function HolidayTravelDetail_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(12, HolidayTravelDetail_Conditional_1_Conditional_12_Template, 4, 2, "button", 10);
    \u0275\u0275conditionalCreate(13, HolidayTravelDetail_Conditional_1_Conditional_13_Template, 4, 3, "a", 11);
    \u0275\u0275conditionalCreate(14, HolidayTravelDetail_Conditional_1_Conditional_14_Template, 8, 2);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(22, "div", 18)(23, "div", 19)(24, "div", 20)(25, "div", 21);
    \u0275\u0275text(26, "\u57F7\u884C\u6D3B\u52D5\u5730\u9EDE");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 22);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 23)(30, "div", 21);
    \u0275\u0275text(31, "\u5047\u65E5\u5929\u6578");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div");
    \u0275\u0275conditionalCreate(33, HolidayTravelDetail_Conditional_1_Conditional_33_Template, 2, 1, "span", 24)(34, HolidayTravelDetail_Conditional_1_Conditional_34_Template, 2, 0, "span", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 23)(36, "div", 21);
    \u0275\u0275text(37, "\u7533\u8ACB\u65E5\u671F");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(40, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div", 19)(42, "div", 23)(43, "div", 21);
    \u0275\u0275text(44, "\u958B\u59CB\u65E5\u671F");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(47, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 23)(49, "div", 21);
    \u0275\u0275text(50, "\u7D50\u675F\u65E5\u671F");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(53, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(54, HolidayTravelDetail_Conditional_1_Conditional_54_Template, 5, 2, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 26)(56, "div", 27)(57, "div", 21);
    \u0275\u0275text(58, "\u6D3B\u52D5\u4E3B\u65E8\u53CA\u5167\u5BB9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "div", 25);
    \u0275\u0275text(60);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275conditionalCreate(61, HolidayTravelDetail_Conditional_1_Conditional_61_Template, 9, 0, "div", 14);
    \u0275\u0275conditionalCreate(62, HolidayTravelDetail_Conditional_1_Conditional_62_Template, 2, 3, "div", 28);
    \u0275\u0275conditionalCreate(63, HolidayTravelDetail_Conditional_1_Conditional_63_Template, 1, 4, "app-approval-timeline", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_17_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(r_r3.holidayDays != null ? 33 : 34);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(40, 17, r_r3.createdAt, "yyyy-MM-dd"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(47, 20, r_r3.startDate, "yyyy-MM-dd"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(53, 23, r_r3.endDate, "yyyy-MM-dd"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(r_r3.projectCode || r_r3.projectName ? 54 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(r_r3.purpose);
    \u0275\u0275advance();
    \u0275\u0275conditional(r_r3.participants && r_r3.participants.length > 0 ? 61 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(r_r3.installments && r_r3.installments.length > 0 ? 62 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_17_0 = ctx_r1.approvalTask()) ? 63 : -1, tmp_17_0);
  }
}
...
var HolidayTravelDetail = class _HolidayTravelDetail {
  ...
  }, dependencies: [RouterLink, ApprovalTimeline, InstallmentsTable, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HolidayTravelDetail, [{
    type: Component,
    args: [{ selector: "app-holiday-travel-detail", imports: [RouterLink, DatePipe, ApprovalTimeline, InstallmentsTable], template: `<div class="container-fluid py-3">
  @if (request(); as r) {
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
      <div class="flex items-center gap-2 flex-wrap">
        ...
        <h4 class="mb-0">\u5047\u65E5\u57F7\u884C\u6D3B\u52D5\u7533\u8ACB <span class="font-monospace text-muted">{{ r.requestNo }}</span></h4>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HolidayTravelDetail, { className: "HolidayTravelDetail", filePath: "src/app/features/admin/holiday-travel-requests/pages/holiday-travel-detail/holiday-travel-detail.ts", lineNumber: 17 });
})();
export {
  HolidayTravelDetail
};
//# sourceMappingURL=chunk-4VSHWJWU.js.map
