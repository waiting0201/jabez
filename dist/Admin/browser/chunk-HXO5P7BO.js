...
var ApprovalTaskService = class _ApprovalTaskService {
  ...
  review(id, applicationType, action, reviewNote, estimatedRefundDate, refundedAt, closeAdvance) {
    return this.http.patch(`${environment.apiUrl}/approval-tasks/${applicationType}/${id}/review`, { action, reviewNote, applicationType, estimatedRefundDate, refundedAt, closeAdvance }).pipe(switchMap((updated) => this.getAll().pipe(map(() => updated))));
  }
...
//# sourceMappingURL=chunk-HXO5P7BO.js.map
