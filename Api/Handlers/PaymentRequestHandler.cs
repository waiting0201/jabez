    ...
    IApprovalFlowService approvalFlow)
{
    ...
    public async Task<IActionResult> SubmitAsync(HttpRequest req, string id)
    {
        ...
        // 自動跳過「申請人即審核者」的步驟
        var (startStep, autoApproved, _) = await approvalFlow.ResolveStartingStepAsync(pr.ApprovalItemId, userId, "payment_request");
