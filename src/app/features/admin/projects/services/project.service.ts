...
const MOCK_PROJECTS: Project[] = [
  {
    id:  1, code: 'P2024-001', status: 'closed',
  ...
  {
    id:  2, code: 'P2024-002', status: 'active',
  ...
  {
    id:  3, code: 'P2025-001', status: 'active',
  ...
  {
    id:  4, code: 'P2024-003', status: 'closed',
    departmentId: 3, departmentName: '業務部',
    budgetAmount: 750000,  actualAmount: 620000,  businessAmount: 700000,
    createdAt: new Date('2024-04-20'),
  },
  {
    id:  5, code: 'P2024-004', status: 'closed',
    departmentId: 2, departmentName: '資訊部',
  ...
  {
    id:  8, code: 'P2024-007', status: 'closed',
    departmentId: 1, departmentName: '管理部',
    budgetAmount: 200000,  actualAmount: 180000,  businessAmount: 160000,
    createdAt: new Date('2024-09-12'),
  },
  {
    id:  9, code: 'P2024-008', status: 'active',
    departmentId: 2, departmentName: '資訊部',
  ...
  {
    id: 10, code: 'P2024-009', status: 'active',
    departmentId: 4, departmentName: '財務部',
    budgetAmount: 880000,  actualAmount: 0,        businessAmount: 850000,
    createdAt: new Date('2024-11-18'),
  },
  {
    id: 11, code: 'P2024-010', status: 'active',
    departmentId: 3, departmentName: '業務部',
  ...
  {
    id: 12, code: 'P2025-002', status: 'active',
    departmentId: 2, departmentName: '資訊部',
    budgetAmount: 1600000, actualAmount: 800000,  businessAmount: 1500000,
    createdAt: new Date('2025-02-14'),
  },
  {
    id: 13, code: 'P2025-003', status: 'active',
    departmentId: 1, departmentName: '管理部',
  ...
  {
    id: 14, code: 'P2025-004', status: 'active',
    departmentId: 4, departmentName: '財務部',
    budgetAmount: 720000,  actualAmount: 680000,  businessAmount: 700000,
    createdAt: new Date('2025-04-22'),
  },
  {
    id: 15, code: 'P2025-005', status: 'active',
    departmentId: 3, departmentName: '業務部',
  ...
  {
    id: 22, code: 'P2026-001', status: 'active',
    departmentId: 4, departmentName: '財務部',
    budgetAmount: 920000,  actualAmount: 0,        businessAmount: 880000,
    createdAt: new Date('2026-01-06'),
  },
  {
    id: 23, code: 'P2026-002', status: 'active',
    departmentId: 3, departmentName: '業務部',
